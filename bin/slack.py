#!python
"""Slack Saved Search Alert Script for Splunk.

Derived from @samuelks' Python Pagerduty Module
https://github.com/samuel/python-slack
"""
...
EVENTS_URL = 'events.slack.com/generic/2010-04-15/create_event.json'


class SlackException(Exception):

    """Exceptions for Slack objects and methods."""
...
class Slack(object):  # pylint: disable=R0903

    """Class for triggering Slack Incidents."""
...
def get_slack_chat_url(config_file):
    ...
    @return: Slack Service Integration API Key.
    @rtype: str
    """
...
def main():
    """Inits the slack API and renders events to the API."""
    # We'll serialize this dict into JSON -> Slack Details.
    details = {'env': {}, 'events': []}
